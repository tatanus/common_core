...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/tatanus/<REPO>.git
   cd <REPO>
   ```
...
- **Issues**: Use the [Issues](https://github.com/tatanus/<REPO>/issues) tab.

Thank you for contributing and helping make **<REPO>** better!
